...
我从这回实验中对 Linux 系统的认识更加深刻，看出来 Linux 内核的严格性与模块性，对之前日常使用 Linux 的时候，对 dkms 之类的东西有了更深的认识。预计可以将其应用于释放电脑性能(指玩黑山起源)。而对驱动程序的简单编写，也让我对最近英伟达开源驱动到底还是坑有了进一步认识。同时进一步掌握了在互联网上搜索资料的能力。
